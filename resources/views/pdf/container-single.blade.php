            ...
            <table class="mt-2">
               <tbody>
                  <tr>
                     ...
                     <td style="width: 70%">{{$container->data[0]->entry_date}}</td>
                  </tr>
                  <tr>
                     <td>Nomor Agenda</td>
                     <td class="text-center">:</td>
                     <td style="width: 70%">{{$container->data[0]->doc_no}}</td>
                  </tr>
                  <tr>
                     <td>Nama Importir</td>
                     <td class="text-center">:</td>
                  ...
                  <tr>
                     ...
                     <td class="text-center">:</td>
                     <td style="width: 70%">{{$container->data[0]->entry_container1}}</td>
                  </tr>
                  <tr>
                     <td>Hasil Analisis</td>
                     <td class="text-center">:</td>
                     <td style="width: 70%">{{$conDesc->desc}}</td>
                  </tr>
                  <tr>
                     <td>Nama Analisis</td>
                     <td class="text-center">:</td>
                  ...
                  <tr>
                     <td colspan="3" style="height: 200px">
                        Salinan gambar dari mesin pindai
                        <hr>
                        <div class="d-flex">

                        
                        <img src="http:{{$container->data[0]->entry_con1_image}}" width="50%" alt="">
                        <img src="http:{{$container->data[0]->entry_xray_image2}}" width="50%" alt="">
                     </div>
                     </td>
